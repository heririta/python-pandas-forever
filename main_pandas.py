...
# print(wine_df.head())
# print(wine_df.iloc[2,1]) # mengakses data pada baris index ke 2 dan column index ke 0

# mengunakan slicing pada iloc[]
# print(wine_df.iloc[:,0]) # mengakses semua baris dan column index ke 0

# print(wine_df.iloc[0,:7]) # mengakses baris index 0 dan 7 column index pertama

# print(wine_df.iloc[1:3, 0]) # mengakses dari baris index ke 1 sampai index ke 3, column index 0
...
# print(wine_df.loc[0,'country']) # mengakses row index ke 0 , nama kolom 'country'
# print(wine_df.loc[0:5, 'country'])
# print(wine_df.loc[:,['taster_name','taster_twitter_handle','points']].head()) # semua row, untuk column2 tertentu

# *alternatif lain
# namadf[[list string nama columns]][row index]
# print(wine_df[['country', 'province']][:].head()) # menampilkan column tertentu
# print(wine_df[['country', 'province']][:5]) # menampilkan 5 baris awal

# menganti index
# .set_index('nama columns')
# print(wine_df.set_index('title').head()) # cara ini kurang tepat karena termasuk modifikasi, dan modifikasi itu tidak mengunakan dataframe asal
...
# print(wine_df.loc[(wine_df['country']=='Italy') & (wine_df['points']>=90)].head()) # where di query sql
...
# print(wine_df.loc[wine_df['price'].isna(), ['country', 'price']].head()) # select country, price form wine_df where price is null
